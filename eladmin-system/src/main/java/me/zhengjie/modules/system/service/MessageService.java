...
public interface MessageService extends IService<Message> {
    ...
    * @return PageResult
    */
    PageResult<Message> queryAll(MessageQueryCriteria criteria, Page<Object> page);
    ...
    * @throws IOException /
    */
    void download(List<Message> all, HttpServletResponse response) throws IOException;
}